...
public class GamePanel extends JPanel implements ActionListener{
    ...
    GamePanel(){
        ...
        this.setBackground(new Color(25, 27, 43)); //
        this.setFocusable(true);
        this.addKeyListener(new MyKeyApater());
        startGame();
    }
    ...
    public Color changeColor(){
        if (applesEaten > 10){
            return new Color(133, 56, 201);
        }
        else if (applesEaten > 5){
            return new Color(123, 4, 7);
        }
        return new Color(128, 183, 224);
    }
    ...
    public class MyKeyApater extends KeyAdapter{
        @Override
